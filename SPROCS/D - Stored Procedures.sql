...
--@@IDENTITY is a global variable that holds the last-generated IDENTITY value for a table with an IDENTITY column
--@@ERROR is a global variable that containes the error number generated by the last INSERT/UPDATE/DELETE statement. 
--@@ERROR is not changed by doing a SELECT statement. When the INSERT/UPDATE/DELETE is successful, @@ERROR will have a 
--value of zero; otherwise, it will have the value of the speccific error number that was generated
--@@ROWCOUNT is a global variable that contains the number of rows 
/*
